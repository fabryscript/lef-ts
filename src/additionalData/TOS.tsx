  ...
  return (
    <ScrollView>
      <Card>
        ...
        <Card.Content>
          <Paragraph>
            NFORMATIVA PRIVACYai sensi e per gli effetti di cui all’art. 13del
            Regolamento UE 2016/679- GDPRrelativo alla protezione delle persone
            fisiche con riguardo al trattamento dei dati personali,nonché alla
            libera circolazione di tali dati e che abrogalaDirettiva
            95/46/CEIlRegolamento Europeo n. 679 del 27 aprile 2016 (di
            seguitoGDPR) sul trattamento dei dati personali prevedela tutela
            delle persone fisiche con riguardo al trattamento dei dati
            personali.Ai sensi dell’art. 13 delGDPR,E.B.E.R.-Ente Bilaterale
            Emilia Romagna (di seguito )invitaa prendere atto
            dellapresenteinformativa.1.Estremi identificativi del Titolare e
            dati di contatto del DPOIl Titolare del trattamento èE.B.E.R.- Ente
            Bilaterale Emilia Romagna-sede legale diViaDe’ Preti n.
            ...
            ANAGRAFICI e IDENTIFICATIVI PERSONALI;CREDENZIALI DI ACCESSO E
            PASSWORD;DATIFISCALI;DATI DI CONTATTO POSTALE, TELEFONICO,
            ...
            strumentali necessari per ilraggiungimento delle finalitàsopra
            espresse.Tutte le operazioni di trattamento dei dati sono attuate in
            modo dagarantire l’integrità, la riservatezza e ladisponibilità dei
            ...
            trattamentosolo per iltempo necessariorispetto alle specifiche
            finalità di raccolta, indi per la sola necessità di
            osservareobblighi dileggeo di perseguireogni altro finelecito e
            legittimo.7.Ambito di comunicazione e diffusione dei datiIn
            relazione alle finalità indicate, i dati potranno essere
            comunicatiai dipendenti e collaboratori all'interno dellastruttura
            del Titolare nella loro qualità di incaricati del
            trattamento,designati privacy, amministratori di sistema,i quali li
            trattano secondo le disposizioni specificatamente impartite nel
            rispetto della normativa vigente inmateria di privacye di sicurezza
            dei dati.All'esterno della struttura del Titolare, i dati possono
            ...
            disposizioni di legge o da ordini delle autorità. I dati possono
            altresì essere comunicatiacollaboratori esterni esocietà esternedi
            cui il Titolare si avvale per ragioni di natura tecnica e
            organizzativa,nell'instaurazione e gestione dei rapporti congli
            utenti;aziende operanti nel settore del trasporto edei
            servizi;istituti di credito; società di recupero crediti;
            professionisti e consulenti; aziende che forniscono
            ...
            agli artt.7,15, 16, 17 18, 20, 21 e 22 del Regolamento UE 2016/679-
            GDPRL’interessato ha il diritto di proporre reclamo, ai sensi
            dell’art. 77 GDPR, all’Autorità di controllo (Garante per
            laProtezione dei Dati Personali-www.garanteprivacy.it) e di
            esercitare i diritti di seguito elencati,se ed in
            ...
            15-Diritto di accessoL’interessato ha il diritto di ottenere dal
            titolare del trattamento la conferma che sia o menoin corso
            untrattamento di dati personali che lo riguardano e in tal caso, di
            ottenere l’accesso ai dati personali e alleinformazioni riguardanti
            il trattamento.Art. 16- Diritto di rettificaL'interessato ha il
            diritto di ottenere dal titolare del trattamento la rettifica dei
            dati personali inesatti che loriguardano senza ingiustificato
            ritardo. Tenuto conto delle finalità del trattamento, l'interessato
            ha il diritto diottenere l'integrazione dei dati personali
            incompleti, anche fornendo una dichiarazione integrativa.Art. 17-
            Diritto alla cancellazione (diritto all’oblio)L'interessato ha il
            diritto di ottenere dal titolare del trattamento la cancellazione
            dei dati personali che loriguardano senza ingiustificato ritardo e
            il titolare del trattamento ha l'obbligo di cancellare senza
            ingiustificatoritardo i dati personali, secondo quanto previsto dal
            Regolamento.Art. 18- Diritto di limitazione del
            trattamentoL'interessato ha il diritto di ottenere dal titolare del
            trattamento la limitazione del trattamento quando ricorreuna delle
            seguenti ipotesi:a) l'interessato contesta l'esattezza dei dati
            personali, per il periodo necessario al titolare del trattamento
            perverificare l'esattezza di tali dati personali;b) il trattamento è
            illecito e l'interessato si oppone alla cancellazione dei dati
            personali e chiede invece che nesia limitato l'utilizzo;c) benché il
            titolare del trattamento non ne abbia più bisogno ai fini del
            trattamento, i dati personali sononecessari all'interessato per
            l'accertamento, l'esercizio o la difesa di un diritto in sede
            giudiziaria;d) l'interessato si è opposto al trattamento ai sensi
            dell'articolo 21, paragrafo 1, in attesa della verifica in
            meritoall'eventuale prevalenza dei motivi legittimi del titolare del
            trattamento rispetto a quelli dell'interessato.Art. 20- Diritto alla
            portabilità dei datiL'interessato ha il diritto di ricevere in un
            formato strutturato, di uso comune e leggibile da
            dispositivoautomatico i dati personali che lo riguardano forniti a
            untitolare del trattamento e ha il diritto di trasmettere talidati a
            un altro titolare del trattamento senza impedimenti da parte del
            titolare del trattamento cui li ha forniti.Nell'esercitare i propri
            diritti relativamente alla portabilità dei dati a norma del
            paragrafo 1, l'interessato ha ildiritto di ottenere la trasmissione
            diretta dei dati personali da un titolare del trattamento all'altro,
            setecnicamente fattibile.Art. 21- Diritto di
            opposizioneL'interessato ha il diritto di opporsi in qualsiasi
            momento, per motivi connessi alla sua situazione particolare,
            altrattamento dei dati personali che lo riguardano ai sensi
            dell'articolo 6, paragrafo 1, lettere e) o f), compresa
            laprofilazione sulla base di tali disposizioni.Art. 22- Diritto di
            non essere sottoposto a processo decisionale automatizzato, compresa
            la profilazioneL'interessato ha il diritto di non essere sottoposto
            a una decisione basata unicamente sul trattamentoautomatizzato,
            compresa la profilazione, che produca effetti giuridiciche lo
            riguardano o che incida in modoanalogo significativamente sulla sua
            persona.10.Modifiche alla presente informativaLa presente
