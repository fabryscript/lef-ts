    ...
    <ScrollView>
      ...
      <Card>
        <Card.Actions>
          ...
          <Button mode="outlined" style={{width: "50%", height: "100%"}} onPress={() => navigation.navigate("Riepilogo")}>
...
export default connect(null, mapDispatch)(FaseGrassi);
